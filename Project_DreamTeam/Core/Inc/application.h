/**************************************************************************//**
 * @file     application.h
 * @brief    global application header file for shared values and functionality
 * @version  V1.0.0
 * @date     May 30, 2023
 ******************************************************************************/
...
/**
 * @package application
 * @def INC_APPLICATION_H_
 * @brief This is global application header for shared values and functionality
 *
 */
 ...
 * @return @ref SEMAPHORE_FAILURE on any osFailure and @ref APPLICATION_OK on success
 */
